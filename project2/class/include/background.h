...
struct background
{
  ...
  double spin_dmeff; /**< \f$ j_{dmeff} \f$ : spin of dark matter with effective interactions */
  ...
  int index_bg_dkappa_dmeff;  /**< dmeff dkappa/dtau */
  int index_bg_dkappaT_dmeff; /**< dmeff dkappa/dtau, for temperature */
  int index_bg_cdmeff2;       /**< dmeff speed of sound squared */
